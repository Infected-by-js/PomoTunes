  ...
  ({name, Icon, keys}: ModeItem) => {
    return (
      <button
        ...
        key={name}
        className={clsx(
          'text-dark  focus:bg-accent-300 outline-none dark:text-accent-100 focus:dark:text-accent-900 text-sm flex items-center w-full h-10 hover:bg-accent-300 px-2 hover:cursor-pointer',
